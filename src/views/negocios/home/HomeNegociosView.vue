...
<template>
  ...
  <!-- <div class="grid grid-cols-4 gap-6 gap-y-10">
    ...
    <router-link v-for="negocio in getMisNegocios" :key="'negocio-'+negocio.idnegocio" :to="{ name: PageEnum.VER_NEGOCIO, params: { id: negocio.idnegocio } }" class="flex flex-col items-center justify-center w-full max-w-md mx-auto">
