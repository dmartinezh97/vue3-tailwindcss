  ...
  <div class="grid grid-cols-2 -p-2 lg:-m-4 h-screen-nav">
    <div class="flex items-center bg-gradient-to-t from-gris via-rosa to-rosaclaro">
      <div class="ml-14 mr-8">
        <h1 class="text-5xl font-semibold tracking-wide text-white">¿Qué tipo de negocio vas a crear?</h1>
      </div>
    </div>
    <div class="relative flex flex-col justify-between bg-white max-w-full">
      <div class="p-8">
        <div class="flex flex-col justify-center items-center">
          <RadioGroup v-model="tipoNegocio" class="space-y-4">
      ...
      <div class="flex justify-between items-center px-8 py-6 border-t-2 border-gray-100 bg-white">
        ...
        <BasicButton @click="onClickSiguiente" text="Siguiente"></BasicButton>
      </div>
    </div>
  </div>
</template>